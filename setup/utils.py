...
def loaddata(args):
    if args.dataset == 'mnist':
        ...
        trainset = datasets.MNIST(root=args.root+'/data', train=True, transform=trans, download=False)
        testset = datasets.MNIST(root=args.root+'/data', train=False, transform=trans, download=False)
